...
<x-backpack::menu-dropdown title="Sales" icon="la la-chart-line">
    ...
    <x-backpack::menu-dropdown title="Enquiries" icon="la la-question-circle" nested="true">
        ...
        <x-backpack::menu-dropdown-item title="Virtual Number Enquiries ({{ $enqCounts['virtual'] ?? 0 }})"
            icon="la la-user-times" :link="backpack_url('enquiries/virtual-number')" />
        <x-backpack::menu-dropdown-item title="WhatsApp Campaign Enquiries ({{ $enqCounts['whatsapp'] ?? 0 }})"
            icon="la la-user-times" :link="backpack_url('enquiries/whatsapp-campaign')" />
        <x-backpack::menu-dropdown-item title="Unassigned Quick Enquiries ({{ $enqCounts['unassigned_quick'] ?? 0 }})"
            icon="la la-user-times" :link="backpack_url('enquiries/unassigned-quick')" />
        <x-backpack::menu-dropdown-item title="Assigned Quick Enquiries ({{ $enqCounts['assigned_quick'] ?? 0 }})"
            icon="la la-user-times" :link="backpack_url('enquiries/assigned-quick')" />
        <x-backpack::menu-dropdown-item title="Unassigned Long Enquiries ({{ $enqCounts['unassigned_long'] ?? 0 }})"
            icon="la la-user-times" :link="backpack_url('enquiries/unassigned-long')" />
        <x-backpack::menu-dropdown-item title="Assigned Long Enquiries ({{ $enqCounts['assigned_long'] ?? 0 }})"
            icon="la la-user-times" :link="backpack_url('enquiries/assigned-long')" />
        <x-backpack::menu-dropdown-item title="Campaign" icon="la la-list" :link="backpack_url('campaign')" />
    ...
    <x-backpack::menu-dropdown title="Quotation" icon="la la-file-alt" nested="true">
        ...
        <x-backpack::menu-dropdown-item title="Approved Quotations" icon="la la-check-circle" :link="backpack_url('quotation-form/approved')" />
    </x-backpack::menu-dropdown>
    ...
    <x-backpack::menu-dropdown title="Booking" icon="la la-book-open" nested="true">
        ...
        <x-backpack::menu-dropdown-item title="Xceler8 Booking List" icon="la la-list" :link="backpack_url('booking')" />

        <x-backpack::menu-dropdown-item title="Pending Payment Bookings" icon="la la-rupee-sign" :link="backpack_url('booking/pending-payment')" />

        <x-backpack::menu-dropdown-item title="Nil Payment Bookings" icon="la la-receipt" :link="'#'" />

        <x-backpack::menu-dropdown-item title="Dummy Bookings" icon="la la-flask" :link="backpack_url('booking/dummy')" />

        <x-backpack::menu-dropdown-item title="DMS OTF Dump" icon="la la-database" :link="route('enquiry.otf-bookings')" />

        <x-backpack::menu-dropdown title="Pending" icon="la la-clock" nested="true">
            <x-backpack::menu-dropdown-item title="DMS Booking Data" icon="la la-database" :link="backpack_url('booking/pending-dms')" />
            <x-backpack::menu-dropdown-item title="Sales Order (SO Number)" icon="la la-file-alt"
    ...
    <x-backpack::menu-dropdown title="Transactions" icon="la la-handshake" nested="true">
        ...
        <x-backpack::menu-dropdown-item title="Ready To Invoice" icon="la la-file-invoice-dollar"
            :link="backpack_url('booking/ready-to-invoice')" />

        <x-backpack::menu-dropdown title="Pending" icon="la la-clock" nested="true">
            <x-backpack::menu-dropdown-item title="Incomplete VOTFs (@sales)" icon="la la-exclamation-triangle"
                :link="backpack_url('booking/pending-incomplete-votfs')" />
            ...
            <x-backpack::menu-dropdown-item title="RTO" icon="la la-truck" :link="backpack_url('booking/pending-rto')" />
            <x-backpack::menu-dropdown-item title="Registration Number" icon="la la-hashtag" :link="backpack_url('booking/pending-registration')" />
            <x-backpack::menu-dropdown-item title="Deliveries" icon="la la-truck" :link="backpack_url('booking/pending-deliveries')" />
            <x-backpack::menu-dropdown-item title="Financier Delivery Order" icon="la la-file-signature"
                :link="backpack_url('bookingr/pending-do')" />
        </x-backpack::menu-dropdown>

        <x-backpack::menu-dropdown-item title="RTO Agent Tracker" icon="la la-user-tie" :link="backpack_url('booking/rto-agent-tracker')" />

        <x-backpack::menu-dropdown-item title="Brokerage" icon="la la-hand-holding-usd" :link="backpack_url('booking/brokerage')" />

        <x-backpack::menu-dropdown-item title="Erroneous Entries" icon="la la-exclamation-circle"
            :link="backpack_url('co-dealer/erroneous')" />
    </x-backpack::menu-dropdown>
    ...
    <x-backpack::menu-dropdown title="CRM Sales" icon="la la-headset" nested="true">
        ...
        {{-- <x-backpack::menu-dropdown title="Followup" icon="la la-phone" nested="true">
            <x-backpack::menu-dropdown title="Enquiry" icon="la la-clipboard-list" nested="true">
                ...
                <x-backpack::menu-dropdown-item title="Int in Finance" icon="la la-file-invoice-dollar"
                    :link="backpack_url('crm-sales/followup/enquiry/int-finance')" />
                <x-backpack::menu-dropdown-item title="Int in Ceramic/PPF" icon="la la-spray-can"
                    :link="backpack_url('crm-sales/followup/enquiry/int-ceramic-ppf')" />
            </x-backpack::menu-dropdown>
            ...
            <x-backpack::menu-dropdown title="Booking" icon="la la-bookmark" nested="true">
                ...
                <x-backpack::menu-dropdown-item title="Int in Finance" icon="la la-file-invoice-dollar"
                    :link="backpack_url('crm-sales/followup/booking/int-finance')" />
                <x-backpack::menu-dropdown-item title="Int in Ceramic/PPF" icon="la la-spray-can"
                    :link="backpack_url('crm-sales/followup/booking/int-ceramic-ppf')" />
            </x-backpack::menu-dropdown>
        </x-backpack::menu-dropdown> --}}
        ...
        {{-- Activations --}}
        <x-backpack::menu-dropdown-item title="Activations" icon="la la-toggle-on" :link="backpack_url('crm-sales/activations/list')" />

        {{-- Alerts --}}
        <x-backpack::menu-dropdown title="Alerts" icon="la la-bell" nested="true">
            <x-backpack::menu-dropdown-item title="Fup Comments Mismatch" icon="la la-exclamation-circle"
                :link="backpack_url('crm-sales/alerts/fup-comments-mismatch')" />
            <x-backpack::menu-dropdown-item title="Fup Date Mismatch" icon="la la-calendar-times"
                :link="backpack_url('crm-sales/alerts/fup-date-mismatch')" />
            <x-backpack::menu-dropdown-item title="Wrongfully Lost Enquiries" icon="la la-user-times"
                :link="backpack_url('crm-sales/alerts/wrongfully-lost-enquiries')" />
            <x-backpack::menu-dropdown-item title="Fake Test Drive" icon="la la-ban" :link="backpack_url('crm-sales/alerts/fake-test-drive')" />
            <x-backpack::menu-dropdown-item title="Purchase Type Mismatch (Exchange)" icon="la la-exchange-alt"
                :link="backpack_url('crm-sales/alerts/purchase-type-mismatch')" />
        </x-backpack::menu-dropdown>
        ...
        <x-backpack::menu-dropdown title="Concerns" icon="la la-exclamation-triangle" nested="true">
            ...
            <x-backpack::menu-dropdown title="Internal" icon="la la-building" nested="true">
                <x-backpack::menu-dropdown-item title="Enquiry" icon="la la-question-circle" :link="'#'" />
                <x-backpack::menu-dropdown-item title="Test Drive" icon="la la-car" :link="'#'" />
                <x-backpack::menu-dropdown-item title="Live Bookings" icon="la la-bookmark" :link="'#'" />
                <x-backpack::menu-dropdown-item title="Cancelled Bookings" icon="la la-ban" :link="'#'" />
                <x-backpack::menu-dropdown-item title="Delivered Vehicles" icon="la la-truck-loading"
                    :link="'#'" />
            </x-backpack::menu-dropdown>
            ...
            <x-backpack::menu-dropdown-item title="Escalated" icon="la la-arrow-circle-up" :link="'#'" />

        </x-backpack::menu-dropdown>

        {{-- Outstanding Management --}}
        <x-backpack::menu-dropdown title="Outstanding Management" icon="la la-sliders-h" nested="true">
            <x-backpack::menu-dropdown-item title="Bookings" icon="la la-book-open" :link="'#'" />
            <x-backpack::menu-dropdown-item title="Delivered Vehicles" icon="la la-truck-loading"
                :link="'#'" />
        </x-backpack::menu-dropdown>
    ...
    <x-backpack::menu-dropdown title="Claims" icon="la la-file-medical" nested="true">
        <x-backpack::menu-dropdown-item title="Exchange" icon="la la-exchange-alt" :link="'#'" />
        <x-backpack::menu-dropdown-item title="Welcome" icon="la la-hand-holding-heart" :link="'#'" />
        <x-backpack::menu-dropdown-item title="Loyalty" icon="la la-award" :link="'#'" />
        <x-backpack::menu-dropdown-item title="CSD" icon="la la-shield-alt" :link="'#'" />
        <x-backpack::menu-dropdown-item title="Corporate" icon="la la-building" :link="'#'" />
        <x-backpack::menu-dropdown-item title="Oem Retail Support" icon="la la-handshake" :link="'#'" />
        <x-backpack::menu-dropdown-item title="Oem Liquidation Support" icon="la la-boxes" :link="'#'" />
    </x-backpack::menu-dropdown>

    {{-- Sales Cashier --}}
    <x-backpack::menu-dropdown title="Sales Cashier" icon="la la-cash-register" nested="true">
        <x-backpack::menu-dropdown-item title="Issue Receipt" icon="la la-receipt" :link="'#'" />
        <x-backpack::menu-dropdown-item title="Special Discount" icon="la la-percent" :link="'#'" />
        <x-backpack::menu-dropdown-item title="Registration Charges" icon="la la-registered" :link="'#'" />
    </x-backpack::menu-dropdown>

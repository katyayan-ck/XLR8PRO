{{-- ORIGINAL PATH: resources/views/admin/booking/edit.blade.php --}}
                        ...
                        <div class="card-body">
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-4 form-group">
                                    ...
                                    <input type="text" class="form-control" value="{{ $entry->booking_amount }}"
                                        readonly>
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-3 form-group">
                                    ...
                                    <select name="care_of" id="care_of" class="form-control form-select" required>
                                        ...
                                        <option value="1" {{ $entry->care_of_type == 1 ? 'selected' : '' }}>Son of
                                        </option>
                                        <option value="2" {{ $entry->care_of_type == 2 ? 'selected' : '' }}>Daughter
                                            of
                                        </option>
                                        <option value="3" {{ $entry->care_of_type == 3 ? 'selected' : '' }}>Married
                                            to
                                        </option>
                                        <option value="4" {{ $entry->care_of_type == 4 ? 'selected' : '' }}>Guardian
                                            Name
                                        </option>
                                        <option value="5" id="ownedByOption"
                                            {{ $entry->care_of_type == 5 ? 'selected' : '' }}>Owned By</option>
                                    </select>
                                </div>
                                ...
                                <div class="col-sm-3 form-group">
                                    ...
                                    <input type="text" name="care_of_name" id="care_of_name"
                                        class="form-control uppercase" value="{{ $entry->care_of }}" required>
                                </div>
                                ...
                                <div class="col-sm-3 form-group">
                                    ...
                                    <select name="gender" id="gender" class="form-control form-select" required>
                                        ...
                                        <option value="Transgender"
                                            {{ $entry->gender == 'Transgender' ? 'selected' : '' }}>Transgender</option>
                                    </select>
                                </div>
                                ...
                                <div class="col-sm-3 form-group">
                                    ...
                                    <select name="occupation" id="occupation" class="form-control form-select" required>
                                        ...
                                        <option value="Business"
                                            {{ in_array($occ, ['Business', 'business']) ? 'selected' : '' }}>
                                            Business</option>
                                        <option value="Salaried (Govt.)"
                                            {{ $occ === 'Salaried (Govt.)' ? 'selected' : '' }}>
                                    ...
                                    <select name="branch" id="branch" class="form-select" required>
                                        ...
                                        @foreach ($data['branches'] as $branch)
                                            <option value="{{ $branch->code }}"
                                                {{ $entry->branch_code == $branch->code ? 'selected' : '' }}>
                                                {{ $branch->name }}
                                            </option>
                                        @endforeach
                                    </select>
                                    ...
                                    <select name="location_id" id="location" class="form-select" required>
                                        ...
                                        @foreach ($data['locations'] as $location)
                                            ...
                                            <option value="{{ $location->code ?? '' }}"
                                                {{ (string) $entry->location_code === (string) ($location->code ?? '') ? 'selected' : '' }}>
                                                {{ ($location->name ?? '') . ' - ' . ($location->code ?? '') }}
                                            </option>
                                        @endforeach
                                        <option value="0" {{ $entry->location_code == 0 ? 'selected' : '' }}>OTHER
                                        </option>
                                    </select>
                                </div>
                                    ...
                                    <div class="row" id="referred_by_fields"
                                        ...
                                        <div class="col-sm-2 form-group">
                                            <label for="ref_mobile_no">Mobile No. <span class="required-mark"
                                                    style="display: {{ $entry->r_name ? 'inline' : 'none' }};">*</span></label>
                                            <input type="text" name="ref_mobile_no" id="ref_mobile_no"
                                                class="form-control" value="{{ $entry->r_mobile ?? '' }}" maxlength="10"
                                        ...
                                        <div class="col-sm-2 form-group">
                                            <label for="ref_chassis_reg_no">Chassis / Regn. No. <span
                                                    class="required-mark"
                                                    style="display: {{ $entry->r_name ? 'inline' : 'none' }};">*</span></label>
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-2 form-group">
                                    <label for="enummaster2">Brand (Make 2) <span class="required-mark"
                                            id="make2-required" style="display: none;">*</span></label>
                                    <select name="enummaster2" id="enummaster2" class="form-select">
                                        <option value="">Please Select...</option>
                                        @foreach ($data['enum_master'] ?? [] as $enum)
                                            <option value="{{ $enum->code ?? ($enum['code'] ?? '') }}"
                                                {{ $entry->exist_oem2 == ($enum->code ?? ($enum['code'] ?? '')) ? 'selected' : '' }}>
                                                {{ $enum->value ?? ($enum['value'] ?? '') }}
                                            </option>
                                        @endforeach
                                    </select>
                                ...
                                <div class="col-sm-4 form-group">
                                    <label for="odometer_reading">Vehicle Odometer Reading <span class="required-mark"
                                            style="display: none;">*</span></label>
                                    <input type="text" name="odometer_reading" id="odometer_reading"
                                        class="form-control" value="{{ $entry->odo_reading }}" disabled>
                                </div>
                            ...
                            <div class="row">
                                ...
                                @php
                                    \Log::info('🔍 [EDIT-SEGMENT] Pre-selection debug', [
                                        ...
                                        'strict_match_found' => collect($data['segments'])->contains(
                                            fn($s) => $s->code === $entry->segment_code,
                                        ),
                                        'loose_match_found' => collect($data['segments'])->contains(
                                            fn($s) => $s->code == $entry->segment_code,
                                        ),
                                        'matched_segment' => collect($data['segments'])->first(
                                            fn($s) => (string) $s->code === (string) $entry->segment_code,
                                        ),
                                    ]);
                                @endphp
                                <div class="col-sm-3 form-group">
                        ...
                        <div class="card-body">
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-3 form-group" id="refrence_no_group"
                                    ...
                                    <input type="text" name="refrence_no" id="refrence_no"
                                        class="form-control uppercase" value="{{ $entry->online_bk_ref_no }}"
                                        {{ $entry->b_mode == 'Online' ? 'required' : 'disabled' }}>
                                </div>

                                <div class="col-sm-3 form-group">
                                    <label for="booking_source">Booking Source <span
                                            class="required-mark">*</span></label>
                                    <select name="booking_source" id="booking_source" class="form-select" required>
                                        <option value="">Please Select...</option>
                                        <option value="Dealer" {{ $entry->b_source == 'Dealer' ? 'selected' : '' }}>
                                            Dealer
                                            Sourcing</option>
                                        <option value="DSA" {{ $entry->b_source == 'DSA' ? 'selected' : '' }}>DSA
                                        </option>
                                    </select>
                                </div>
                                ...
                                <div class="col-sm-3 form-group" id="dsa_details_group"
                                    ...
                                    <select name="dsa_details" id="dsa_details" class="form-select"
                                        {{ $entry->b_source == 'DSA' ? 'required' : 'disabled' }}>
                                        <option value="">Please Select...</option>
                                        @foreach ($data['dsa_details'] as $dsa)
                                            <option value="{{ $dsa->id }}"
                                                {{ $entry->dsa_id == $dsa->id ? 'selected' : '' }}>
                                                {{ $dsa->name }} - {{ $dsa->mobile }}
                                            </option>
                                        @endforeach
                                    </select>
                                    ...
                                    <select name="saleconsultant" id="saleconsultant" class="form-select" required>
                                        ...
                                        @foreach ($data['saleconsultants'] as $consultant)
                                            <option value="{{ $consultant->person_code }}"
                                                {{ $entry->consultant == $consultant->person_code ? 'selected' : '' }}>
                                ...
                                <div class="col-sm-3 form-group" id="financier_box"
                                    ...
                                    <select name="financier" id="financier" class="form-select"
                                        {{ $entry->fin_mode == 'In-house' ? 'required' : 'disabled' }}>
                                        <option value="">Select Financier</option>
                                        @foreach ($data['financiers'] as $fin)
                                            <option value="{{ $fin->id }}"
                                                data-short_name="{{ $fin->short_name }}"
                                ...
                                <div class="col-sm-3 form-group" id="loan_status_box"
                                    ...
                                    <select name="loan_status" id="loan_status" class="form-select"
                                        ...
                                        <option value="Complete"
                                            {{ $entry->loan_status == 'Complete' ? 'selected' : '' }}>Complete</option>
                                    </select>
                                </div>
...
@section('after_scripts')
        ...
        $(document).ready(function() {
            ...
            if (!segVal) {
                ...
                if (fallback) {
                    ...
                    console.error(
                        '❌ [EDIT-SEGMENT] Both val() and data-selected-segment are empty! Check controller segment IDs vs DB segment_code.'
                        );
                }
            } else {
            ...
            function populateSelect2(selectId, rawData, valueKey, textKey = valueKey, extraData = {}) {
                ...
                data.forEach(item => {
                    ...
                    let value = item[valueKey] || item.name || item.colr_name || item.id || item
                        .chassis_no || item.value;
                    let text = item[textKey] || item.name || item.colr_name || item.chassis_no || item
                        .value || item.id;
            ...
            $('#customercat').on('change', function() {
                ...
                $('#careofnamelabel').html(isFirm ? 'Owner Name <span class="required-mark">*</span>' :
            ...
            $('#segment').on('change', function() {
                ...
                $.get(url)
                    .done(function(data) {
                        console.log('✅ [SEGMENT-CHANGE] Models received:', Array.isArray(data) ? data
                            .length : Object.keys(data).length, 'items', data);
                        populateSelect2('#model', data, 'code', 'name');
                        $('#model').prop('disabled', false);
                    })
                    .fail(function(xhr) {
                        console.error('❌ [SEGMENT-CHANGE] get-models XHR failed', xhr.status, xhr
                            .responseText);
                    });
            });
            ...
            $('#variant').on('change', function() {
                ...
                if (segmentId && modelVal) {
                    ...
                    $.get(accUrl).done(function(data) {
                        populateSelect2('#accessories', data, 'part_no', 'item', {
                            accessory: true
                        });
            ...
            async function restoreVehicleDetails() {
                ...
                if (!saved.segment) {
                    console.error(
                        '❌ [RESTORE] saved.segment is empty — cannot restore cascade. Check $entry->segment_code in DB vs segment IDs from XpricingHelper::getSegments().'
                        );
                    return;
                }

                const currentSegVal = $('#segment').val();
                console.log('🔍 [RESTORE-STEP1] #segment val:', currentSegVal, '| expected:', saved.segment,
                    '| match:', String(currentSegVal) === String(saved.segment));
                if (String(currentSegVal) !== String(saved.segment)) {
                    console.warn(
                        '⚠️ [RESTORE-STEP1] Select2 not reflecting PHP selected attr — forcing val to:',
                        saved.segment);
                ...
                await $.get(modelsUrl)
                    .done(function(data) {
                        ...
                        console.log('✅ [RESTORE-STEP2] Models received:', count, 'items. First 3:', JSON
                            .stringify(toArray(data).slice(0, 3)));
                        if (count === 0) console.warn(
                            '⚠️ [RESTORE-STEP2] 0 models — check get-models controller for segment_id:',
                            saved.segment);
                        populateSelect2('#model', data, 'code', 'name');
                        $('#model').val(saved.model).prop('disabled', false);
                        const actualModel = $('#model').val();
                        console.log('🔍 [RESTORE-STEP2] #model → set to:', saved.model, '| got:',
                            actualModel);
                        if (actualModel !== saved.model) {
                            const available = $('#model option').map(function() {
                                return $(this).val();
                            }).get();
                            console.warn('⚠️ [RESTORE-STEP2] model val mismatch! Available options:',
                                available);
                        }
                    })
                    .fail(function(xhr) {
                        console.error('❌ [RESTORE-STEP2] get-models XHR failed', xhr.status, xhr.statusText,
                ...
                await $.get(variantsUrl)
                    .done(function(data) {
                        ...
                        if (count === 0) console.warn('⚠️ [RESTORE-STEP3] 0 variants for model:', saved
                            .model);
                        populateSelect2('#variant', data, 'code', 'name', {
                            variant: true
                        });
                        ...
                        $('#seating').val(seating);
                        console.log('🔍 [RESTORE-STEP3] #variant → set to:', saved.variant, '| got:', $(
                            '#variant').val(), '| seating:', seating);
                    })
                    .fail(function(xhr) {
                        console.error('❌ [RESTORE-STEP3] get-variants XHR failed', xhr.status, xhr
                            .statusText);
                    });
                ...
                await $.get(colorsUrl)
                    .done(function(data) {
                        ...
                        if (count === 0) console.warn('⚠️ [RESTORE-STEP4] 0 colors for variant:', saved
                            .variant);
                        populateSelect2('#color', data, 'code', 'name', {
                            color: true
                        });
                        $('#color').val(saved.color).prop('disabled', false).trigger('change');
                        console.log('🔍 [RESTORE-STEP4] #color → set to:', saved.color, '| got:', $(
                            '#color').val());
                        updateFromColor();
                        console.log('🔍 [RESTORE-STEP4] vh_id:', $('#vh_id').val(), '| seating:', $(
                            '#seating').val());
                    })
                    .fail(function(xhr) {
                        console.error('❌ [RESTORE-STEP4] get-colors XHR failed', xhr.status, xhr
                        .statusText);
                    });
                    ...
                    await $.get(accUrl)
                        .done(function(data) {
                            ...
                            if (saved.accessories.length > 0) {
                                ...
                                console.log('🔍 [RESTORE-STEP5] After .val() — actual selection:', $(
                                    '#accessories').val());
                            } else {
                        ...
                        .fail(function(xhr) {
                            console.error('❌ [RESTORE-STEP5] get-accessories XHR failed', xhr.status, xhr
                                .statusText);
                        });
                }
    ...
    <script>
        ...
        $(document).ready(function() {
            ...
            const $refFields = $(
                '#ref_customer_name, #ref_mobile_no, #ref_existing_model, #ref_variant, #ref_chassis_reg_no');
    ...
    <script>
        ...
        $(document).ready(function() {
            ...
            if (isFirm) {
                $('#care_of option[value=""], #care_of option[value="1"], #care_of option[value="2"], #care_of option[value="3"], #care_of option[value="4"]')
                    .remove();
                    ...
                    $.ajax({
                            ...
                            success: function(response) {
                                ...
                                $.each(response, function(key, location) {
                                    ...
                                    let selected =
                                        String(selectedLocation).trim() === String(location
                                            .code).trim() ?
                                        'selected' :
                                        '';

                                ...
                                <div class="row">
                                    ...
                                    <div class="row d-none bg-light p-3 rounded" id="exchangeFields">
                                        ...
                                        <div class="col-md-4 mb-3">
                                            ...
                                            <!-- Notice 'name' is removed so it doesn't submit to the database -->
...
@push('after_scripts')
    ...
    <script>
        ...
        // Debounce: Prevents firing functions repeatedly during fast typing
        ...
        // Reusable AJAX Keyword Dropdown Loader
        ...
        // Reusable generic dropdown fetcher for Models, Variants, Colors, Locations
            ...
            $.get(url)
                .done((response) => {
                    ...
                    $.each(response, (code, item) => {
                        // Handle simple values or objects (like variants with data attributes)
        ...
        $(function() {
            ...
            // Note: $segmentCode duplicate check is already triggered in its change event above

                                ...
                                <div class="table-responsive mb-4">
                                    <table class="table table-bordered text-center align-middle mb-0"
                                        ...
                                        <tbody>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <div class="form-control bg-white h-auto border-0 text-wrap text-center"
                                                                style="min-width: 150px;">{{ $fup?->remarks ?: '—' }}
                                                            </div>
                                                        </td>
                                                        <td>
                                                            <div class="form-control bg-white h-auto border-0 text-wrap text-center"
                                                                style="min-width: 120px;">{{ $fup?->remark_type ?: '—' }}
                                                            </div>
                                                        </td>
                                                        <td>
                                                            <div class="form-control bg-white h-auto border-0 text-wrap text-center"
                                            ...
                                            @else
                                                <tr>
                                                    <td colspan="8" class="text-muted py-3 bg-white text-center">No
                                    ...
                                    <table class="table table-bordered text-center align-middle mb-0"
                                        ...
                                        <tbody>
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="form-control bg-white h-auto border-0 text-wrap text-center"
                                                        style="min-width: 200px;">{{ $enquiry?->remarks ?: '—' }}</div>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td
                                                ...
                                                <td>
                                                    <div class="form-control bg-white h-auto border-0 text-center">
                                                        {{ $enquiry?->quick_status ?? ($enquiry?->stage ?? '—') }}</div>
                                                </td>
                                                <td>
                                                    <div class="form-control bg-white h-auto border-0 text-center">—</div>
                                                </td>
                                                <td>
                                                    <div class="form-control bg-white h-auto border-0 text-wrap text-center"
                        ...
                        <div class="card-body">
                            <div class="row mb-4">
                                <div class="col-md-3 mb-3"><label class="form-label">Enquiry Stage</label><input
                                        ...
                                        value="{{ $enquiry?->dms_enquiry_stage ?? ($enquiry?->stage ?? '—') }}" readonly
                    ...
                    <div class="card enquiry-card">
                        ...
                        <div class="card-body">
                                        ...
                                        @if (isset($creFups) && count($creFups) > 0)
                                            @foreach ($creFups as $index => $cre)
                                                <tr>
                                                    ...
                                                    <td>
                                                        <div class="form-control bg-white h-auto border-0 text-center">
                                                            {{ $cre?->cre_fup_deviation_stage ?: '—' }}</div>
                                                    </td>
                                                    <td>
                                                        <div class="form-control bg-white h-auto border-0 text-center">
                                                            {{ $cre?->cre_enq_stage ?: '—' }}</div>
                                                    </td>
                                                    <td>
                                                        <div class="form-control bg-white h-auto border-0 text-center">
                                                            {{ $cre?->cre_customer_stage ?: '—' }}</div>
                                                    </td>
                                                    <td>
                                                        <div class="form-control bg-white h-auto border-0 text-wrap text-center"
                            ...
                            <div class="row">
                                <div class="col-md-2 mb-3">
                                    <label class="form-label">Call Duration</label>
                                    <input type="number" name="cre_fup_call_duration" class="form-control" placeholder="Enter duration" value="{{ old('cre_fup_call_duration') }}">
                                </div>
                                <div class="col-md-2 mb-3">
                                    <label class="form-label">Deviation Stage</label>
                                    <input type="text" name="cre_fup_deviation_stage" class="form-control"
                                        value="{{ old('cre_fup_deviation_stage') }}">
                                </div>
                                <div class="col-md-2 mb-3">
                                ...
                                <table class="table table-bordered text-center align-middle mb-0"
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="form-control bg-white h-auto border-0 text-nowrap text-center">
                                                    {{ $enquiry?->dms_enquiry_stage ?? ($enquiry?->stage ?? '—') }}</div>
                                            </td>
                                            <td>
                                                <div class="form-control bg-white h-auto border-0 text-nowrap text-center">
                                                    {{ $lastCre?->cre_enq_stage ?? '—' }}</div>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td class="fw-bold align-middle table-secondary text-center px-3 text-dark">

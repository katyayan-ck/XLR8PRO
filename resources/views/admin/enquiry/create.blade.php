                        ...
                        <form method="POST" id="enquiryForm"
                            ...
                            <div id="full_enquiry_form" style="{{ $isVirtual ? 'display: none;' : '' }}">
                                ...
                                <div class="card-body">
                                    <div class="row">
                                        ...
                                        <div class="col-md-2 mb-3">
                                            ...
                                            <input type="text" id="vpo_input" class="form-control mt-2 d-none" placeholder="Enter VPO Manually" value="{{ $enquiry->bpo ?? '' }}">
                                        </div>
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="row mt-3">
                                        <div class="col-md-12">
                                            <h4 class="mb-3">Exchange Valuation Details (Processed by Exchange Team)</h4>
                                            <div class="row">
                                                ...
                                                <div class="col-md-3 mb-3"><label class="form-label">Reason for Case Lost:</label> <input class="form-control" disabled value="{{ $enquiry->lost_reason }}"></div>
                                            </div>
                                        </div>
                                    </div>
                                    @endif
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="row" style="opacity: 0.8; pointer-events:none;">
                                        ...
                                        <div class="col-md-3 mb-3">
                                            ...
                                            <input type="text" class="form-control" value="{{ isset($enquiry) && ($enquiry->x8_booking_date || $enquiry->booking_date) ? \Carbon\Carbon::parse($enquiry->x8_booking_date ?? $enquiry->booking_date)->format('d-M-Y') : '—' }}" readonly>
                                        </div>
                                        <div class="col-md-3 mb-3">
                                            <label class="form-label">Booking No.</label>
                                            <input type="text" class="form-control" value="{{ $enquiry->x8_booking_no ?? $enquiry->booking_no ?? '—' }}" readonly>
                                        </div>
                                        <div class="col-md-3 mb-3">
                                            <label class="form-label">OTF No.</label>
                                            <input type="text" class="form-control" value="{{ $enquiry->oem_otf_no ?? '—' }}" readonly>
                                        </div>
                                    </div>
                                ...
                                {{-- =========================== CRE FOLLOW UP (Req 6) =========================== --}}
                                <h3 class="mb-0 ms-3 mt-4">CRE Follow Up</h3>
                                <div class="card-body">
                                    <div class="row">
                                        <div class="col-md-3 mb-3">
                                        ...
                                        <div class="col-md-3 mb-3">
                                            ...
                                            <input type="text" id="cre_next_fup_date" name="cre_next_fup_date" class="form-control" value="{{ old('cre_next_fup_date', $enquiry->cre_next_fup_date ?? '') }}" placeholder="YYYY-MM-DD">
                                        </div>
                                        <div class="col-md-3 mb-3">
...
@push('after_scripts')
    ...
    <script>
        ...
        $(function() {
            ...
            $('#referee_phone').on('keyup change', debounce(function() {
                ...
                $.get("{{ route('enquiry.reference-users') }}", { type, mobile }, function(response) {
                    ...
                    if (isEmpty) {
                        ...
                        $.each(response, (code, name) => html += `<option value="${code}">${name}</option>`);
            ...
            setupDynamicLocation('vpo_select', 'vpo_input', 'bpo', currentEnquiry.bpo);
                ...
                fetch(`https://api.postalpincode.in/pincode/${pincode}`)
                    ...
                    .then(data => {
                        if (data && data[0] && data[0].Status === 'Success') {
                            ...
                            handleRender('vpo_select', 'vpo_input', 'bpo', bpos, 'Select VPO', currentEnquiry.bpo);

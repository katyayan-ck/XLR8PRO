    ...
    <form method="POST" id="enquiryForm"
                ...
                <div class="row">
                    ...
                    <div class="col-md-3 mb-3">
                        ...
                        <select name="call_nature" id="call_nature" class="form-control form-select" required>
                            ...
                            <option value="{{ $item['code'] }}" {{ old('call_nature', $enquiry->call_nature ?? '') ==
                                $item['code'] ? 'selected' : '' }}>
                                {{ $item['value'] }}
                            </option>
                            @endforeach
                ...
                <div class="row">
                    <div class="col-md-12 mb-3">
                        ...
                        <textarea name="remarks" class="form-control"
                            rows="2">{{ old('remarks', $enquiry->remarks ?? '') }}</textarea>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div id="full_enquiry_form" class="{{ $isVirtual ? 'd-none' : 'd-flex flex-column' }}">
                        ...
                        <table class="table table-bordered text-center align-middle mb-0"
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="form-control bg-white h-auto border-0 text-nowrap text-center">
                                            {{ $enquiry->quick_enquiry_date ?
                                            \Carbon\Carbon::parse($enquiry->quick_enquiry_date)->format('d-M-Y') : '—'
                                            }}
                                        </div>
                                    </td>
                                    <td>
                                        <div class="form-control bg-white h-auto border-0 text-nowrap text-center">
                                            {{ $enquiry->quick_enq_assign_date ?
                                            \Carbon\Carbon::parse($enquiry->quick_enq_assign_date)->format('d-M-Y') :
                                            '—' }}
                                        </div>
                                    </td>
                                </tr>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="form-control bg-white h-auto border-0 text-nowrap text-center">
                                            {{ $enquiry->enq_assign_date ?
                                            \Carbon\Carbon::parse($enquiry->enq_assign_date)->format('d-M-Y') : '—' }}
                                        </div>
                                    </td>
                                </tr>
                                @endif
                    ...
                    <div class="row">
                        <div class="col-md-3 mb-3">
                            ...
                            <select name="enquiry_type" id="enquiry_type" class="form-control form-select" required>
                                ...
                                <option value="{{ $etype['code'] }}" {{ old('enquiry_type', $enquiry->enquiry_type ??
                                    '') == $etype['code'] ? 'selected' : '' }}>
                                    {{ $etype['value'] }}</option>
                                @endforeach
                            </select>
                        ...
                        <div class="col-md-3 mb-3">
                            ...
                            <select name="planned_campaign" id="planned_campaign" class="form-control form-select">
                                ...
                                <option value="{{ $name }}" {{ old('planned_campaign', $enquiry->planned_campaign ?? '')
                                    == $name ? 'selected' : '' }}>
                                    {{ $name }}</option>
                                @endforeach
                            </select>
                        ...
                        <div class="row w-100 m-0 p-0 {{ $isReference ? 'd-flex' : 'd-none' }}" id="referenceFields">
                            <div class="col-md-3 mb-3">
                                ...
                                <select name="referred_by" id="referred_by" class="form-control form-select">
                                    ...
                                    <option value="Customer" {{ old('referred_by', $enquiry->referred_by ?? '') ==
                                        'Customer' ? 'selected' : '' }}>
                                        Customer</option>
                                    <option value="Team Member" {{ old('referred_by', $enquiry->referred_by ?? '') ==
                                        'Team Member' ? 'selected' : '' }}>
                                        Team Member</option>
                                    <option value="Promoter" {{ old('referred_by', $enquiry->referred_by ?? '') ==
                                        'Promoter' ? 'selected' : '' }}>
                                        Promoter</option>
                                </select>
                            </div>
                        ...
                        <div class="col-md-3 mb-3">
                            ...
                            <select name="likely_purchase_date" class="form-control form-select">
                                ...
                                <option value="{{ $item['code'] }}" {{ old('likely_purchase_date', $enquiry->
                                    likely_purchase_date ?? '') == $item['code'] ? 'selected' : '' }}>
                                    {{ $item['value'] }}</option>
                                @endforeach
                            </select>
                        </div>
                        ...
                        {{-- <div class="col-md-3 mb-3">
                            ...
                            <select name="dealer_branch" id="dealer_branch" class="form-control form-select" required>
                                ...
                                <option value="{{ $code }}" {{ old('dealer_branch', $enquiry->dealer_branch ?? '') ==
                                    $code ? 'selected' : '' }}>
                                    {{ $name }}</option>
                                @endforeach
                            </select>
                    ...
                    <div class="row">
                        <div class="col-md-3 mb-3">
                            ...
                            <select name="segment_code" id="segment_code" class="form-control form-select" required>
                                ...
                                <option value="{{ $code }}" {{ old('segment_code', $enquiry->segment_code ?? '') ==
                                    $code ? 'selected' : '' }}>
                                    {{ $name }}</option>
                                @endforeach
                            </select>
                        ...
                        <div class="row w-100 m-0 p-0" id="commercialSection" style="display:none;">
                            <div class="col-md-3 mb-3">
                                ...
                                <select name="usage_area" class="form-control form-select">
                                    ...
                                    <option value="{{ $item['code'] }}" {{ old('usage_area', $enquiry->usage_area ?? '')
                                        == $item['code'] ? 'selected' : '' }}>
                                        {{ $item['value'] }}</option>
                                    @endforeach
                                </select>
                            ...
                            <div class="col-md-3 mb-3">
                                ...
                                <select name="km_travelled_daily" class="form-control form-select">
                                    ...
                                    <option value="{{ $item['code'] }}" {{ old('km_travelled_daily', $enquiry->
                                        km_travelled_daily ?? '') == $item['code'] ? 'selected' : '' }}>
                                        {{ $item['value'] }}</option>
                                    @endforeach
                                </select>
                            </div>
                            <div class="col-md-3 mb-3">
                                ...
                                <select name="application_type" id="application_type" class="form-control form-select">
                                    ...
                                    <option value="{{ $item['code'] }}" {{ old('application_type', $enquiry->
                                        application_type ?? '') == $item['code'] ? 'selected' : '' }}>
                                        {{ $item['value'] }}</option>
                                    @endforeach
                                </select>
                            </div>
                            <div class="col-md-3 mb-3">
                                ...
                                <select name="application" id="application" class="form-control form-select">
                                    ...
                                    <option value="{{ $item['code'] }}" {{ old('application', $enquiry->application ??
                                        '') == $item['code'] ? 'selected' : '' }}>
                                        {{ $item['value'] }}</option>
                                    @endforeach
                                </select>
            ...
            <div class="card enquiry-card" style="order: {{ $order['customer_primary'] }};">
                ...
                <div class="card-body">
                    <div class="row">
                        ...
                        @endif
                        <div class="col-md-3 mb-3">
                            <label class="form-label">Alternate Contact No. <small
                        ...
                        <div class="col-md-3 mb-3">
                            ...
                            <select name="gender" class="form-control form-select" required>
                                ...
                                <option value="{{ $item['code'] }}" {{ old('gender', $enquiry->gender ?? '') ==
                                    $item['code'] ? 'selected' : '' }}>
                                    {{ $item['value'] }}</option>
                                @endforeach
                            </select>
                        ...
                        <div class="col-md-3 mb-3">
                            ...
                            <select id="territory" name="territory" class="form-control form-select" required>
                                ...
                                <option value="OWN TERRITORY" {{ old('territory', $enquiry->territory ?? '') == 'OWN
                                    TERRITORY' ? 'selected' : '' }}>
                                    OWN TERRITORY</option>
                                <option value="OTHER TERRITORY" {{ old('territory', $enquiry->territory ?? '') == 'OTHER
                                    TERRITORY' ? 'selected' : '' }}>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-3 mb-3">
                            ...
                            <select class="form-control form-select" disabled style="background-color: #e9ecef;">
                                ...
                                <option value="{{ $item['code'] }}" {{ old('purchase_type', $enquiry->purchase_type ??
                                    '') == $item['code'] ? 'selected' : '' }}>
                                    {{ $item['value'] }}</option>
                                @endforeach
                            </select>
                        ...
                        <div class="col-md-3 mb-3">
                            ...
                            <select name="purchase_type_crm" id="purchase_type_crm" class="form-control form-select"
                                ...
                                @foreach ($purchase_types as $item)
                                <option value="{{ $item['code'] }}" {{ old('purchase_type_crm', $enquiry->
                                    purchase_type_crm ?? '') == $item['code'] ? 'selected' : '' }}>
                                    {{ $item['value'] }}</option>
                                @endforeach
                            </select>
                        </div>
                        ...
                        <div class="col-md-3 mb-3">
                            ...
                            <select name="fin_mode" id="fin_mode" class="form-control form-select">
                                ...
                                <option value="In-house" {{ old('fin_mode', $enquiry->fin_mode ?? '') == 'In-house' ?
                                    'selected' : '' }}>
                                    In-house</option>
                                <option value="Customer Self" {{ old('fin_mode', $enquiry->fin_mode ?? '') == 'Customer
                                    Self' ? 'selected' : '' }}>
                                    Customer Self</option>
                                <option value="Cash" {{ old('fin_mode', $enquiry->fin_mode ?? '') == 'Cash' ? 'selected'
                                    : '' }}>Cash
                                </option>
                                <option value="Yet To Decide" {{ old('fin_mode', $enquiry->fin_mode ?? '') == 'Yet To
                                    Decide' ? 'selected' : '' }}>
                                    Yet To Decide</option>
                                <option value="Purchase Plan Cancelled" {{ old('fin_mode', $enquiry->fin_mode ?? '') ==
                                    'Purchase Plan Cancelled' ? 'selected' : '' }}>
                        ...
                        <div class="col-md-3 mb-3" id="financierbox" style="display:none;">
                            ...
                            <select name="financier" id="financier" class="form-control form-select">
                                ...
                                <option value="{{ $financier->id }}" {{ old('financier', $enquiry->financier ?? '') ==
                            ...
                            <div class="bg-light p-3 rounded border">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-3 mb-3"><label class="form-label">Expected Price:</label>
                                        <input class="form-control" disabled value="{{ $enquiry->expected_price }}">
                                    </div>
                                    <div class="col-md-3 mb-3"><label class="form-label">Offered Price:</label>
                                        <input class="form-control" disabled value="{{ $enquiry->offered_price }}">
                                    </div>
                                    <div class="col-md-3 mb-3"><label class="form-label">Exchange Bonus:</label>
                                        <input class="form-control" disabled value="{{ $enquiry->exchange_bonus }}">
                                    </div>
                ...
                <div class="card-body">
                    ...
                    <div class="row mb-4" style="opacity: 0.8; pointer-events:none;">
                        <div class="col-md-3 mb-3">
                            ...
                            <select id="oem_sc_code_display" class="form-control form-select" readonly tabindex="-1"
                                style="background-color: #e9ecef;">
                                ...
                                <option value="{{ $consultant['person_code'] }}"
                                    ...
                                    {{ old('sc_code', $enquiry->sc_code ?? '') == $consultant['person_code'] ?
                                    'selected' : '' }}>
                    ...
                    <div class="row">
                        <div class="col-md-3 mb-3">
                            ...
                            <select name="x8_sc_code" id="x8_sc_code" class="form-control form-select" required>
                                ...
                                <option value="{{ $consultant['person_code'] }}"
                                    ...
                                    data-branch="{{ \App\Services\OrgService::branchName($consultant['primary_branch_code'] ?? '') }}"
                                    data-location="{{ \App\Services\OrgService::locationName($consultant['primary_loc_code'] ?? '') }}"
                                    {{ old('x8_sc_code', $enquiry->x8_sc_code ?? '') == $consultant['person_code'] ?
                                    'selected' : '' }}>
                                    {{ $consultant['display_name'] }} - {{ $consultant['employee_code'] }}
                                </option>
                                @endforeach
                        ...
                        <div class="col-md-3 mb-3">
                            ...
                            <input type="text" name="x8_sc_mile_id" id="x8_sc_mile_id" class="form-control"
                                value="{{ old('x8_sc_mile_id', $enquiry->x8_sc_mile_id ?? '') }}" readonly tabindex="-1"
                    ...
                    <div class="row">
                        <div class="col-md-3 mb-3">
                            ...
                            <select name="occupation_type" class="form-control form-select">
                                ...
                                <option value="{{ $item['code'] }}" {{ old('occupation_type', $enquiry->occupation_type
                                    ?? '') == $item['code'] ? 'selected' : '' }}>
                                    {{ $item['value'] }}</option>
                                @endforeach
                            </select>
                        ...
                        <div class="col-md-3 mb-3">
                            ...
                            <select name="customer_type" class="form-control form-select">
                                ...
                                <option value="{{ $item['code'] }}" {{ old('customer_type', $enquiry->customer_type ??
                                    '') == $item['code'] ? 'selected' : '' }}>
                                    {{ $item['value'] }}</option>
                                @endforeach
                            </select>
                        ...
                        <div class="col-md-3 mb-3">
                            ...
                            <select name="occupation_sub_type" class="form-control form-select">
                                ...
                                <option value="{{ $item['code'] }}" {{ old('occupation_sub_type', $enquiry->
                                    occupation_sub_type ?? '') == $item['code'] ? 'selected' : '' }}>
                                    {{ $item['value'] }}</option>
                                @endforeach
                            </select>
                        </div>
                        ...
                        <div class="col-md-3 mb-3">
                            ...
                            <select name="marital_status" class="form-control form-select">
                                ...
                                <option value="{{ $item['code'] }}" {{ old('marital_status', $enquiry->marital_status ??
                                    '') == $item['code'] ? 'selected' : '' }}>
                                    {{ $item['value'] }}</option>
                                @endforeach
                            </select>
                        ...
                        <div class="col-md-3 mb-3">
                            ...
                            <select name="age_group" class="form-control form-select">
                                ...
                                <option value="{{ $item['code'] }}" {{ old('age_group', $enquiry->age_group ?? '') ==
                                    $item['code'] ? 'selected' : '' }}>
                                    {{ $item['value'] }}</option>
                                @endforeach
                            </select>
                    ...
                    <div class="row">
                        <div class="col-md-4 mb-3">
                            ...
                            <select id="consider_make" name="consider_make" class="form-control form-select">
                                <option value="No Consideration" {{ old('consider_make', $enquiry->consider_make ?? 'No
                                    Consideration') == 'No Consideration' ? 'selected' : '' }}>
                                    No Consideration</option>
                                @foreach ($existing_car_oems as $item)
                                <option value="{{ $item['code'] }}" {{ old('consider_make', $enquiry->consider_make ??
                                    '') == $item['code'] ? 'selected' : '' }}>
                                    {{ $item['value'] }}</option>
                                @endforeach
                            </select>
                    ...
                    <div class="row">
                        <div class="col-md-4 mb-3">
                            ...
                            <select id="consider_make_2" name="consid_brand2" class="form-control form-select">
                                ...
                                @foreach ($existing_car_oems as $item)
                                <option value="{{ $item['code'] }}" {{ old('consid_brand2', $enquiry->consid_brand2 ??
                                    '') == $item['code'] ? 'selected' : '' }}>
                                    {{ $item['value'] }}
                                </option>
                                @endforeach
                        ...
                        <div class="col-md-4 mb-3">
                            ...
                            <input type="text" id="consider_variant_2" name="consid_variant2" class="form-control"
                ...
                <div class="card-body">
                    ...
                    <div class="table-responsive mb-4">
                        <table class="table table-bordered text-center align-middle mb-0"
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td class="fw-bold align-middle table-secondary text-center px-3 text-dark">
                                        {{ ['First', 'Second', 'Third', 'Fourth', 'Fifth', 'Sixth'][$index] ?? $index +
                                        1 . 'th' }}
                                        Fup</td>
                                    <td>
                                        <div class="form-control bg-white h-auto border-0 text-nowrap text-center">
                                    ...
                                    <td>
                                        <div class="form-control bg-white h-auto border-0 text-nowrap text-center">
                                            {{ !empty($fup->planned_followup_date) ?
                                            \Carbon\Carbon::parse($fup->planned_followup_date)->format('d-M-Y') : '—' }}
                                        </div>
                                    </td>
                                    <td>
                                        <div class="form-control bg-white h-auto border-0 text-nowrap text-center">
                                            {{ !empty($fup->actual_followup_date) ?
                                            \Carbon\Carbon::parse($fup->actual_followup_date)->format('d-M-Y') : '—' }}
                                        </div>
                                    </td>
                                    <td>
                                        <div class="form-control bg-white h-auto border-0 text-nowrap text-center">
                    ...
                    <div class="row mb-4" style="opacity: 0.85; pointer-events:none;">
                        ...
                        <div class="col-md-2 mb-3">
                            ...
                            <input type="text" class="form-control" value="{{ $enquiry?->fup_count ?? '—' }}" readonly
                                style="background-color: #e9ecef;">
                        </div>
                        <div class="col-md-2 mb-3">
            ...
            <div class="card enquiry-card" style="order: 9;">
                ...
                <div class="card-body">
                    <div class="row mb-4">
                        <div class="col-md-3 mb-3"><label class="form-label">Enquiry Stage</label><input type="text"
                                class="form-control"
                        ...
                        <div class="col-md-3 mb-3"><label class="form-label">Test Drive Count</label><input type="text"
                                class="form-control" value="{{ $enquiry?->td_count ?? '0' }}" readonly
                                style="background-color: #e9ecef;"></div>
                        <div class="col-md-3 mb-3"><label class="form-label">Test Drive No.</label><input type="text"
                                class="form-control" value="{{ $enquiry?->test_drive_no ?? '—' }}" readonly
                                style="background-color: #e9ecef;"></div>
                        <div class="col-md-3 mb-3"><label class="form-label">Test Drive Date</label><input type="text"
                                class="form-control"
                                value="{{ isset($enquiry) && $enquiry->td_date ? \Carbon\Carbon::parse($enquiry->td_date)->format('d-M-Y') : '—' }}"
                                readonly style="background-color: #e9ecef;"></div>
                        <div class="col-md-3 mb-3"><label class="form-label">Booking Date</label><input type="text"
                                class="form-control"
                    ...
                    <h4 class="fw-bold mb-3">Lost Information</h4>
                    <div class="row" style="pointer-events:none;">
                        <div class="col-md-3 mb-3"><label class="form-label">Lost Reason</label><input type="text"
                                class="form-control" value="{{ $enquiry?->lost_reason ?? '—' }}" readonly></div>
                        <div class="col-md-3 mb-3"><label class="form-label">Lost Sub Reason</label><input type="text"
                                class="form-control" value="{{ $enquiry?->lost_sub_reason ?? '—' }}" readonly></div>
                        <div class="col-md-3 mb-3"><label class="form-label">Lost Detail Reason</label><input
                                type="text" class="form-control" value="{{ $enquiry?->lost_detail_reason ?? '—' }}"
                                readonly></div>
                        <div class="col-md-3 mb-3"><label class="form-label">Lost Remarks</label><input type="text"
                                class="form-control" value="{{ $enquiry?->lost_remarks ?? '—' }}" readonly></div>
                    </div>
                </div>
            </div>
            ...
            <div class="card enquiry-card" style="order: 10;">
                ...
                <div class="card-body">
                        ...
                        <table class="table table-bordered text-center align-middle mb-0"
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="form-control bg-white h-auto border-0 text-nowrap text-center">
                                            {{ $cre?->cre_planned_fup_date ?
                                            \Carbon\Carbon::parse($cre->cre_planned_fup_date)->format('d-M-Y') : '—' }}
                                        </div>
                                    </td>
                                    <td>
                                        <div class="form-control bg-white h-auto border-0 text-nowrap text-center">
                                            {{ $cre?->cre_actual_fup_date ?
                                            \Carbon\Carbon::parse($cre->cre_actual_fup_date)->format('d-M-Y') : '—' }}
                                        </div>
                                    </td>
                                    <td>
                                        <div class="form-control bg-white h-auto border-0 text-nowrap text-center">
                                            {{ $cre?->cre_fup_call_duration ?: '—' }}</div>
                                    </td>
                                    <td>
                                        <div class="form-control bg-white h-auto border-0 text-nowrap text-center">
                                            {{ $cre?->cre_next_fup_date ?
                                            \Carbon\Carbon::parse($cre->cre_next_fup_date)->format('d-M-Y') : '—' }}
                                        </div>
                                    </td>
                                    <td>
                                        <div class="form-control bg-white h-auto border-0 text-center">
                                            {{ $devMap[$cre?->cre_fup_deviation_stage ?? ''] ??
                                            ($cre?->cre_fup_deviation_stage ?: '—') }}
                                        </div>
                                    </td>
                                    <td>
                                        <div class="form-control bg-white h-auto border-0 text-center">
                                    ...
                                    <td>
                                        <div class="form-control bg-white h-auto border-0 text-center">
                                            {{ $custStageMap[$cre?->cre_customer_stage ?? ''] ??
                                            ($cre?->cre_customer_stage ?: '—') }}
                                        </div>
                                    </td>
                                    <td>
                                        <div class="form-control bg-white h-auto border-0 text-wrap text-center"
                                ...
                                @else
                                <tr>
                                    <td colspan="9" class="text-muted py-3 bg-white text-center">No CRE
                                        Follow-up Data Found</td>
                                </tr>
                                @endif
                            </tbody>
                    ...
                    {{-- Editable Input Row --}}
                    <h4 class="fw-bold mb-3">Add CRE Follow Up</h4>
                    <div class="row">
                        {{-- <div class="col-md-2 mb-3">
                            <label class="form-label">Call Duration</label>
                            <input type="text" id="cre_fup_call_duration" name="cre_fup_call_duration"
                                class="form-control" placeholder="HH:MM:SS" maxlength="8"
                                value="{{ old('cre_fup_call_duration') }}" oninput="formatDuration(this)">
                        </div> --}}
                        <div class="col-md-3 mb-3">
                            ...
                            <select name="cre_enq_stage" class="form-control form-select" @if (isset($enquiry)) required
                                @endif>
                                <option value="">Select Option</option>
                                @foreach ($enquiry_stages as $item)
                                <option value="{{ $item['code'] }}" {{ old('cre_enq_stage')==$item['code'] ? 'selected'
                                    : '' }}>
                                    {{ $item['value'] }}</option>
                                @endforeach
                            </select>
                        ...
                        <div class="col-md-3 mb-3">
                            ...
                            <select name="cre_customer_stage" class="form-control form-select" @if (isset($enquiry))
                                required @endif>
                                <option value="">Select Option</option>
                                @foreach ($customer_stages as $item)
                                <option value="{{ $item['code'] }}" {{ old('cre_customer_stage')==$item['code']
                                    ? 'selected' : '' }}>
                                    {{ $item['value'] }}</option>
                                @endforeach
                            </select>
                        ...
                        <div class="col-md-3 mb-3">
                            ...
                            <input type="text" id="cre_next_fup_date" name="cre_next_fup_date" class="form-control"
                                value="{{ old('cre_next_fup_date') }}" placeholder="DD-MMM-YYYY" @if (isset($enquiry))
                                required @endif>
                        </div>
                        <div class="col-md-3 mb-3">
                            ...
                            <textarea name="cre_fup_remarks" class="form-control" rows="1" @if (isset($enquiry))
                                required @endif>{{ old('cre_fup_remarks') }}</textarea>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="card enquiry-card" style="order: 11;">
                ...
                <div class="card-body">
                    @php
                    $scActualDate =
                    $enquiry?->recent_actual_followup_date ?: $enquiry?->first_actual_followup_date;
                    $scNextDate = $enquiry?->next_planned_followup_date;
                    $scGap = '—';
                    if ($scActualDate && $scNextDate) {
                    $scGap =
                    \Carbon\Carbon::parse($scActualDate)->diffInDays(
                    \Carbon\Carbon::parse($scNextDate),
                    ) . ' Days';
                    }
                    ...
                    $creGap =
                    \Carbon\Carbon::parse($creActualDate)->diffInDays(
                    \Carbon\Carbon::parse($creNextDate),
                    ) . ' Days';
                    }
                    @endphp
                    <div class="table-responsive mb-4">
                        <table class="table table-bordered text-center align-middle mb-0"
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td>
                                        <div class="form-control bg-white h-auto border-0 text-nowrap text-center">
                                            {{ $scActualDate ? \Carbon\Carbon::parse($scActualDate)->format('d-M-Y') :
                                            '—' }}
                                        </div>
                                    </td>
                                    <td>
                                        <div class="form-control bg-white h-auto border-0 text-nowrap text-center">
                                            {{ $creActualDate ? \Carbon\Carbon::parse($creActualDate)->format('d-M-Y') :
                                            '—' }}
                                        </div>
                                    </td>
                                </tr>
                                ...
                                <tr>
                                    <td class="fw-bold align-middle table-secondary text-center px-3 text-dark">Enq
                                        Stage</td>
                                    <td>
                                        <div class="form-control bg-white h-auto border-0 text-nowrap text-center">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div
                                            class="form-control bg-white h-auto border-0 d-flex justify-content-center text-center">
                    ...
                    <div class="row">
                        <div class="col-md-12 mb-3">
                            ...
                            <textarea name="remarks" rows="3"
                                class="form-control">{{ old('remarks', $enquiry?->remarks ?? '') }}</textarea>
                        </div>
                    </div>
                </div>
            </div>

        ...
        $(document).ready(function() {
            ...
            function loadLead(leadNo) {
                ...
                $.ajax({
                    ...
                    url: "{{ backpack_url('enquiry/lead') }}/" + encodeURIComponent(leadNo),
            ...
            $.ajax({
                ...
                success: function(response) {
                    ...
                    if (currentLead) {
                        ...
                        $('#color_code').val(currentLead.color_code);

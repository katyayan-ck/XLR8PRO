...
@push('after_scripts')
    ...
    <script>
        ...
        const gridOptions = {
            ...
            rowData: [], // NEW: Switched to client-side data
            pagination: true,
            ...
            onGridReady: params => {
                ...
                // NEW: Fetch all data instantly on load
        ...
        function openColumnBubble() {
            ...
            // NEW: Checkbox heading logic removed entirely as requested.
            // It now simply loops through the available fields and displays them.
        ...
        document.addEventListener('DOMContentLoaded', () => {
            ...
            // NEW: Client-side instant global search

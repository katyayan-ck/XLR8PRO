        ...
        <div class="card">
            <div
                ...
                <div class="d-flex align-items-center gap-3 flex-nowrap">
                    <a href="{{ backpack_url('enquiries/unassigned-quick/create') }}"
                        class="btn btn-blue btn-sm fw-bold shadow-sm">
                        <i class="la la-plus me-1"></i> Add Unassigned Quick Enquiry
                    </a>
...
<script>
    ...
    document.addEventListener('DOMContentLoaded', () => {
                ...
                document.getElementById('exportCsv').addEventListener('click', () => {
                    ...
                    XLSX.writeFile(wb, `unassigned-quick-enquiries-${new Date().toISOString().slice(0, 10)}.xlsx`);
                });

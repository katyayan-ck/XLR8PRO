    ...
    <div class="row">
        ...
        <div class="row d-none" id="referenceFields">
            ...
            <div class="col-md-3 mb-3">
                ...
                <input type="text" name="referee_phone" id="referee_phone" class="form-control" maxlength="10"
    ...
    <div class="row">
        ...
        <div class="col-md-4 mb-3">
            ...
            <input type="text" id="followup_date" name="followup_date" class="form-control"
                value="{{ old('followup_date') }}" placeholder="Select Sales Consultant Follow up Date">
        ...
        <div class="col-md-4 mb-3">
            ...
            <input type="time" name="followup_time" class="form-control" value="{{ old('followup_time') }}"
                required>
...
<div class="card-body">
    ...
    <div class="row">
        ...
        <div class="col-md-3 mb-3">
            ...
            <input type="text" id="tehsil" name="tehsil" class="form-control" value="{{ old('tehsil') }}"
                readonly>
        </div>
    ...
    <div class="row">
        ...
        <div class="row d-none" id="exchangeFields">
            ...
            <div class="col-md-4 mb-3">
                ...
                <select id="exchange_make" name="exchange_make" class="form-control form-select">

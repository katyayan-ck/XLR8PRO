        ...
        <div class="card">
            <div
                ...
                <div class="d-flex align-items-center gap-3 flex-nowrap">
                    <a href="{{ backpack_url('enquiries/whatsApp-campaign/create') }}"
                        class="btn btn-blue btn-sm fw-bold shadow-sm">
                        <i class="la la-plus me-1"></i> Add WhatsApp Campaign Enquiry
                    </a>
...
<script>
    ...
    function openColumnBubble() {
        ...
        allFlatColumns.forEach(col => {
            ...
            if (['serial_no', 'campaign_name', 'action'].includes(col.field)) {
    ...
    document.addEventListener('DOMContentLoaded', () => {
                ...
                document.getElementById('exportCsv').addEventListener('click', () => {
                    ...
                    XLSX.utils.book_append_sheet(wb, ws, "WhatsApp Campaign Enquiries");
                    XLSX.writeFile(wb, `whatsApp-campaign-enquiries-${new Date().toISOString().slice(0, 10)}.xlsx`);
                });
                ...
                document.getElementById('exportPdf').addEventListener('click', () => {
                    ...
                    doc.save(`whatsApp-campaign-enquiries-${new Date().toISOString().slice(0, 10)}.pdf`);
                });
            });

        ...
        <div class="card">
            <div
                ...
                <div class="d-flex align-items-center gap-3 flex-nowrap">
                    <a href="{{ backpack_url('enquiries/assigned-quick/create') }}"
                        class="btn btn-blue btn-sm fw-bold shadow-sm">
                        <i class="la la-plus me-1"></i> Add Assigned Quick Enquiry
                    </a>
...
<script>
    ...
    const columnDefs = [
        ...
        ...ALL_COLUMNS.filter(col => [
                        ...
                        'serial_no',
                        'quick_enq_no',
                        'quick_enq_date_and_time',
                        'quick-assign_date_and_time',
                        'customer_first_name',
                        'customer_phone',
                        'enq_type',
                        'enq_source',
    ...
    document.addEventListener('DOMContentLoaded', () => {
                ...
                document.getElementById('exportCsv').addEventListener('click', () => {
                    ...
                    XLSX.writeFile(wb, `assigned-quick-enquiries-${new Date().toISOString().slice(0, 10)}.xlsx`);
                });

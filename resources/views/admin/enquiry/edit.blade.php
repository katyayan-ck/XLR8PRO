                            ...
                            <div class="row">
                                ...
                                <div class="col-md-3 mb-3">
                                    ...
                                    <select name="lead_no" id="lead_no" class="form-control form-select">
                                        ...
                                        @foreach ($leads as $leadNo => $lead)
                                            <option value="{{ $leadNo }}"
                                                {{ old('lead_no', $enquiry->lead_no) == $leadNo ? 'selected' : '' }}>
                                ...
                                <div class="col-md-3 mb-3">
                                    ...
                                    <select name="source_code" id="source_code" class="form-control form-select" required>
                                        ...
                                        @foreach ($sources as $code => $name)
                                            <option value="{{ $code }}"
                                                {{ old('source_code', $enquiry->source_code) == $code ? 'selected' : '' }}>
                                                {{ $name }}</option>
                                        @endforeach
                                ...
                                <div class="col-md-3 mb-3">
                                    ...
                                    <select name="model_code" id="model_code" class="form-control form-select" required>
                                        ...
                                        @foreach ($models as $code => $name)
                                            <option value="{{ $code }}"
                                                {{ old('model_code', $enquiry->model_code) == $code ? 'selected' : '' }}>
                                ...
                                <div class="col-md-3 mb-3">
                                    ...
                                    <select name="variant_code" id="variant_code" class="form-control form-select" required>
                                        ...
                                        @foreach ($variants as $code => $name)
                                            <option value="{{ $code }}"
                                                {{ old('variant_code', $enquiry->variant_code) == $code ? 'selected' : '' }}>
                                ...
                                <div class="col-md-3 mb-3">
                                    ...
                                    <select name="color_code" id="color_code" class="form-control form-select" required>
                                        ...
                                        @foreach ($colors as $code => $name)
                                            <option value="{{ $code }}"
                                                {{ old('color_code', $enquiry->color_code) == $code ? 'selected' : '' }}>
                                ...
                                <div class="col-md-3 mb-3">
                                    ...
                                    <select name="status" class="form-control form-select" required>
                                        ...
                                        <option value="new"
                                            {{ old('status', $enquiry->status) == 'new' ? 'selected' : '' }}>
                                            New
                                        </option>

                                        <option value="in_followup"
                                            {{ old('status', $enquiry->status) == 'in_followup' ? 'selected' : '' }}>
                                            In Followup
                                        </option>

                                        <option value="quotation_sent"
                                            {{ old('status', $enquiry->status) == 'quotation_sent' ? 'selected' : '' }}>
                                            Quotation Sent
                                        </option>

                                        <option value="quotation_approved"
                                            {{ old('status', $enquiry->status) == 'quotation_approved' ? 'selected' : '' }}>
                                            Quotation Approved
                                        </option>

                                        <option value="booking_done"
                                            {{ old('status', $enquiry->status) == 'booking_done' ? 'selected' : '' }}>
                                            Booking Done
                                        </option>

                                        <option value="lost"
                                            {{ old('status', $enquiry->status) == 'lost' ? 'selected' : '' }}>
                                            Lost
                                        </option>

                                        <option value="cancelled"
                                            {{ old('status', $enquiry->status) == 'cancelled' ? 'selected' : '' }}>
                                            Cancelled
                                        </option>
                                ...
                                <div class="col-12 mb-3">
                                    ...
                                    <textarea name="lost_reason" class="form-control" rows="2">{{ old('lost_reason', $enquiry->lost_reason) }}</textarea>
                                </div>
                                ...
                                <div class="col-md-3 mb-3">
                                    ...
                                    <select name="priority" class="form-control form-select" required>
                                        ...
                                        <option value="high"
                                            {{ old('priority', $enquiry->priority) == 'high' ? 'selected' : '' }}>
                                            High
                                        </option>

                                        <option value="medium"
                                            {{ old('priority', $enquiry->priority) == 'medium' ? 'selected' : '' }}>
                                            Medium
                                        </option>

                                        <option value="low"
                                            {{ old('priority', $enquiry->priority) == 'low' ? 'selected' : '' }}>
                                            Low
                                        </option>
                                ...
                                <div class="col-12 mb-3">
                                    ...
                                    <textarea name="notes" class="form-control" rows="3">{{ old('notes', $enquiry->notes) }}</textarea>
                                </div>

                                <div class="col-12 mb-3">
                                    <label>Conversion Notes</label>

                                    <textarea name="conversion_notes" class="form-control" rows="3">{{ old('conversion_notes', $enquiry->conversion_notes) }}</textarea>
                                </div>
                                ...
                                <div class="col-md-3 mb-3">
                                    ...
                                    <div class="form-check form-switch mt-2">
                                        ...
                                        <input type="checkbox" name="has_extended_warranty" value="1"
                                            ...
                                            {{ old('has_extended_warranty', $enquiry->has_extended_warranty) ? 'checked' : '' }}>

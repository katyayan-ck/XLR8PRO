...
<script>
    ...
    const columnDefs = [
        ...getCols(['serial_no', 'segment', 'sub_segment']).map(col => {
            if (['serial_no'].includes(col.field)) col.pinned = 'left';
            return col;
        }),

        { field: 'code', headerName: 'Model Name' },
        { field: 'oem_name', headerName: 'OEM Code' },
    ...
    const gridOptions = {
        ...
        onGridReady: params => {
            ...
            const defaultFields = ['serial_no', 'segment', 'sub_segment', 'code', 'oem_name', 'name', 'is_active', 'action'];
    ...
    function openColumnBubble() {
        ...
        const allFlatColumns = [
            ...getCols(['serial_no', 'segment', 'sub_segment']),
            { field: 'code', headerName: 'Model Name' },
            { field: 'oem_name', headerName: 'OEM Code' },
            { field: 'name', headerName: 'Custom Name' },
            ...getCols(['is_active']),
        ...
        allFlatColumns.forEach(col => {
            ...
            if (['serial_no', 'segment', 'sub_segment', 'code', 'oem_name', 'name', 'action'].includes(col.field)) {

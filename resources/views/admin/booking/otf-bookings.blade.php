...
<script>
    ...
    document.addEventListener('DOMContentLoaded', () => {
        ...
        document.getElementById('exportCsv')?.addEventListener('click', () => {
            ...
            XLSX.utils.book_append_sheet(workbook, worksheet, 'OTF Bookings');
            XLSX.writeFile(workbook, 'otf-bookings.xlsx');
        });
        ...
        document.getElementById('exportExcel')?.addEventListener('click', () => {
            ...
            doc.text('OTF Bookings Report', 40, 30);
            doc.autoTable({
                columns: exportCols,
                body: rows,
                startY: 50,

                                ...
                                <div class="col-sm-3">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="mobile" id="mobile" class="form-control"
                                            required maxlength="10" value="{{ old('mobile', $enquiry->mobile ?? '') }}"
                                            @if ($quotation) readonly @endif>
                                    </div>
                                </div>
                                ...
                                <div class="col-sm-4">
                                    <div class="form-group">
                                        ...
                                        <select name="gender" id="gender" class="form-control form-select" required>
                                            <option value="Male"
                                                {{ old('gender', $enquiry->gender ?? '') == 'Male' ? 'selected' : '' }}>Male
                                            </option>
                                            <option value="Female"
                                                {{ old('gender', $enquiry->gender ?? '') == 'Female' ? 'selected' : '' }}>
                                                Female</option>
                                            <option value="Transgender"
                                                {{ old('gender', $enquiry->gender ?? '') == 'Transgender' ? 'selected' : '' }}>
                                                Transgender</option>
                                        </select>
                                    </div>
                                </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select name="occupation" id="occupation" class="form-control form-select"
                                            ...
                                            <option value="" disabled
                                                {{ !isset($enquiry->occupation_type) ? 'selected' : '' }}>-- Select
                                                Occupation --</option>
                                            ...
                                            <option value="Salaried (Govt.)"
                                                {{ $occ == 'Salaried (Govt.)' ? 'selected' : '' }}>Salaried (Govt.)
                                            </option>
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-3">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control"
                                            value="{{ $quotation?->vehicleModel?->name }}"
                                            @if (!$quotation) hidden @endif readonly>

                                        @if ($quotation)
                                            <input type="hidden" name="model" value="{{ $q['model_code'] }}">
                                        @else
                                            <select name="model" id="model" class="form-control form-select"
                                                required disabled>
                                                <option value="">Please Select...</option>
                                            </select>
                                        @endif
                                ...
                                <div class="col-sm-3">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control"
                                            value="{{ $quotation?->variant?->display_name }}"
                                            @if (!$quotation) hidden @endif readonly>

                                        @if ($quotation)
                                            <input type="hidden" name="variant" value="{{ $q['variant_code'] }}">
                                        @else
                                            <select name="variant" id="variant" class="form-control form-select"
                                                required disabled>
                                                <option value="">Please Select...</option>
                                            </select>
                                        @endif
                                ...
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        ...
                                        @if ($quotation)
                                            <textarea class="form-control" rows="3" readonly>{{ collect($q['accessories'] ?? [])->implode(', ') }}</textarea>
                                ...
                                <div class="col-sm-2">
                                    <div class="form-group">
                                        <label for="refrenceno">Online Book Ref No. <span class="required-mark"
                                                style="display: none;">*</span></label>
                                        <input type="text" name="refrenceno" id="refrenceno" class="form-control"
                                            disabled>
                                    </div>
                                </div>
                                ...
                                <div class="col-sm-3">
                                    <div class="form-group">
                                        <label for="dsadetails">Select DSA <span class="required-mark"
                                                style="display: none;">*</span></label>
                                        <select name="dsadetails" id="dsadetails" class="form-control form-select"
                                            disabled>
                                ...
                                <div class="col-sm-2">
                                    <div class="form-group">
                                        <label for="saleconsultant">Sales Consultant <span
                                                class="required-mark">*</span></label>
                                        <select name="saleconsultant" id="saleconsultant"
                                ...
                                <div class="col-sm-2">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="expecteddeldate" id="expecteddeldate"
                                            class="form-control" placeholder="dd-mmm-yyyy" required>
                                ...
                                <div class="col-sm-2">
                                    <div class="form-group">
                                        ...
                                        <select name="finmode" id="finmode" class="form-control form-select" required>
                                            <option value="" disabled
                                                {{ !isset($enquiry->fin_mode) ? 'selected' : '' }}>-- Select Finance Mode
                                                --</option>
                                            <option value="In-house"
                                                {{ old('finmode', $enquiry->fin_mode ?? '') == 'In-house' ? 'selected' : '' }}>
                                                In-house</option>
                                            <option value="Customer Self"
                                                {{ old('finmode', $enquiry->fin_mode ?? '') == 'Customer Self' ? 'selected' : '' }}>
                                                Customer Self</option>
                                            <option value="Cash"
                                                {{ old('finmode', $enquiry->fin_mode ?? '') == 'Cash' ? 'selected' : '' }}>
                                                Cash</option>
                                            <option value="Yet To Decide"
                                                {{ old('finmode', $enquiry->fin_mode ?? '') == 'Yet To Decide' ? 'selected' : '' }}>
                                ...
                                <div class="col-sm-3">
                                    <div class="form-group" id="loanstatusbox">
                                        <label for="loanstatus">Loan File Status <span class="required-mark"
                                                style="display: none;">*</span></label>
                                        <select name="loanstatus" id="loanstatus" class="form-control form-select"
                                            disabled required>
...
@push('after_scripts')
    ...
    <script>
        ...
        // Inject data passed from the controller (if converting an enquiry)
        const prefillData = {
            hasQuotation: @json($quotation ? true : false),
            segment: @json($enquiry->segment_code ?? ''),
            model: @json($enquiry->model_code ?? ''),
        ...
        (function() {
            ...
            function initBookingForm() {
                ...
                // TRIGGER PRE-FILL EVENTS FOR CASCADING DROPDOWNS
                ...
                // Auto-fill financier short name if one was pre-selected
                if ($('#financier').val()) {
            ...
            function initFlatpickr() {
                ...
                // Calculate initial age if DOB was pre-filled
                ...
                const bookingPicker = flatpickr('#bookingdate', {
                    ...
                    onChange: function(selectedDates, dateStr, instance) {
                        ...
                        if (bookingDate && window.deliveryPicker) {
                            ...
                            if (window.deliveryPicker.selectedDates[0] && window.deliveryPicker
                                .selectedDates[0] < bookingDate) {
            ...
            function initMasks() {
                $('#panno').mask('AAAAA0000A', {
                    placeholder: 'ABCDE1234F'
                });
                $('#adharno').mask('0000-0000-0000', {
                    placeholder: '1234-5678-9012'
                });
                $('#refrenceno').mask('AAAAAAAAAA', {
                ...
                $('#receiptvoucherinput').mask('00000', {
                    placeholder: '12345',
                    reverse: true
                });
            ...
            function setInitialState() {
                ...
                // Pass true to indicate initial load so pre-filled values are preserved
        ...
        `);
                ...
                $('#buyertype').on('change', function(e) {
                    // Pass false if it is triggered manually by the user
                    togglePurchaseFields(this.value, !e.originalEvent);
                });
                ...
                $('#segment').on('change', function() {
                    ...
                    $.ajax({
                        url: '{{ url('admin/get-models') }}/' + segment,
                        method: 'GET',
                ...
                $('#variant').on('change', function() {
                    ...
                    $.ajax({
                        url: '{{ url('admin/get-colors') }}/' + variantId,
                        method: 'GET',
                        success: function(data) {
                            ...
                            if (colorsArray.length > 0) {
                                populateSelect($('#color'), colorsArray, 'name', 'code', null,
                    ...
                    if (segmentName && modelId && variantId) {
                        $.ajax({
                            url: '../get-accessories/' + $('#segment').val() + '/' + $('#model').val() +
                                '/' + this.value,
                            method: 'GET',
                            success: function(data) {
                                const $accessories = $('#accessories');
            ...
            function toggleFinanceFields(mode) {
                ...
                // FIX: Make the Financier dropdown visible when In-house is selected
                if (isInHouse) {
                    $('#financierbox').show();
                } else {
                    $('#financierbox').hide();
            ...
            function togglePurchaseFields(type, isInitial = false) {
                ...
                function disableAll(arr) {
                    arr.forEach($el => {
                        ...
                        // Only clear the values if this was triggered by a human interacting, NOT on page load
                        if (!isInitial) {
                ...
                } else if (type === 'Exchange Buy' || type === 'First Time Buy' && (document.getElementById('buyertype')
                        .options[document.getElementById('buyertype').selectedIndex].text === 'Exchange Buy')) {
                    makeRequired(fields.base);
                ...
                // Auto-calculate Price Gap for pre-filled data
                if (isInitial) {
            ...
            function populateSelect(selector, data, textKey, valueKey, extra = null, callback = null) {
                ...
                if (typeof data === 'object' && !Array.isArray(data)) {
                    // It's a key-value object { "CODE": "NAME" }
                    $.each(data, function(code, name) {
                        const option = new Option(name, code);
                        select.append(option);
                    });
                } else {
                    // It's an array of objects [ { code: "CODE", name: "NAME" } ]
            ...
            function resetFields(...fields) {
                fields.forEach(field => {
                    field.html('<option value="0" selected disabled>Please Select...</option>').prop('disabled',
                        true);
                });
            }
                ...
                input.off('change.duplicate').on('change.duplicate', function() {
                    ...
                    if (value) {
                        $.ajax({
                            ...
                            success: function(data) {
                                if (data !== 0) {
                                    $('#receiptvoucherwarning').show().text(fieldName.charAt(0)
                                        .toUpperCase() + fieldName.slice(1).replace(/-/g, ' ') +
                                        ' already exists');
            ...
            function toggleRequiredMark(selector, show) {
                if (typeof selector === 'string') {
                    ...
                    selector.forEach(sel => $(sel).siblings('label').find('.required-mark').css('display', show ?
                        'inline' : 'none'));
                } else {
                    $(selector).siblings('label').find('.required-mark').css('display', show ? 'inline' : 'none');
                }

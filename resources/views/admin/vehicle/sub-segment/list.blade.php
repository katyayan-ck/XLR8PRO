...
<script>
    ...
    const gridOptions = {
        ...
        onGridReady: params => {
            ...
            const defaultFields = ['serial_no', 'code', 'name', 'segment','is_active', 'action'];
    ...
    function openColumnBubble() {
        ...
        const allFlatColumns = [
            ...getCols(['serial_no', 'code', 'name', 'segment']),
            ...getCols(['is_active']),
            ...getCols(['action'])
        ];
        ...
        <div class="card">
            ...
            <div
                ...
                <div class="d-flex align-items-center gap-3 flex-nowrap">
                    <a href="{{ backpack_url('vehicle/sub-segment/create') }}" class="btn btn-blue btn-sm fw-bold shadow-sm">

...
@section('title', $title ?? 'All Processes')
        ...
        <div class="card">
            ...
            <div class="card-header bg-gradient-primary d-flex justify-content-between align-items-center flex-nowrap flex-md-nowrap flex-wrap gap-3">
                ...
                <div class="d-flex align-items-center gap-3 flex-nowrap">
                    <a href="{{ backpack_url('iam/process/create') }}" class="btn btn-blue btn-sm fw-bold shadow-sm">
...
<script>
    ...
    let gridApi;
    const defaultFields = ['serial_no', 'module_name', 'code', 'name', 'description', 'is_active', 'action'];

    const columnDefs = [
        ...getCols(['serial_no', 'module_name', 'code', 'name']).map(col => {
            if (col.field === 'serial_no' || col.field === 'code') {
                col.pinned = 'left';
            }
            if (col.field === 'serial_no') col.width = 80;
            return col;
        }),
        ...getCols(['description']),
    ...
    function openColumnBubble() {
        ...
        const allFlatColumns = [
            ...getCols(['serial_no', 'module_name', 'code', 'name', 'description', 'is_active', 'action'])
        ];

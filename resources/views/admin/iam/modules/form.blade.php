...
@section('title', $title ?? 'Module Form')
            ...
            <div class="col-12">
                ...
                <div class="card">
                    ...
                    <div class="card-header text-black">
                        <h2 class="mb-0">
                            {{ isset($module) ? 'Edit Module Information' : 'Add New Module' }}
                        </h2>
                    </div>

                    <div class="card-body">

                        <form method="POST" action="{{ isset($module) ? backpack_url('iam/module/' . $module->id) : backpack_url('iam/module') }}">
                                ...
                                <div class="col-md-4 mb-3">
                                    ...
                                    <div class="form-check form-switch">
                                        ...
                                        <input type="checkbox" id="moduleStatus" name="is_active" value="1"
                                            class="form-check-input" {{ old('is_active', $module->is_active ?? true) ? 'checked' : '' }}>
                                    </div>
                                </div>
...
@push('after_scripts')
    ...
    <script>
        ...
        const activeProcesses = @json($activeProcesses ?? []);
        ...
        $('#moduleStatus').on('change', function () {
            ...
            let displayProcesses = activeProcesses.slice(0, 5);
            ...
            if (activeProcesses.length > 5) {
                html += '<li><strong>+' + (activeProcesses.length - 5) + ' more...</strong></li>';
            }

...
@section('title', $title ?? 'All Permissions')
        ...
        <div class="card">
            ...
            <div class="card-header bg-gradient-primary d-flex justify-content-between align-items-center flex-nowrap flex-md-nowrap flex-wrap gap-3">
                ...
                <div class="d-flex align-items-center gap-3 flex-nowrap">
                    <a href="{{ backpack_url('iam/permission/create') }}" class="btn btn-blue btn-sm fw-bold shadow-sm">
...
<script>
    ...
    let gridApi;
    const defaultFields = ['serial_no', 'module_name', 'process_name', 'name', 'guard_name', 'action'];

    const columnDefs = [
        ...getCols(['serial_no', 'module_name', 'process_name', 'name']).map(col => {
    ...
    function openColumnBubble() {
        ...
        const allFlatColumns = [
            ...getCols(['serial_no', 'module_name', 'process_name', 'name', 'guard_name', 'action'])
        ];

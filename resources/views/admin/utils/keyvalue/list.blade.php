        ...
        <div class="card">
            ...
            <div
                ...
                <div class="d-flex align-items-center gap-3 flex-nowrap">
                    ...
                    <a href="{{ backpack_url('utils/key-value/create') }}" class="btn btn-blue btn-sm fw-bold shadow-sm">
...
.addEventListener('click', () => {
    ...
    XLSX.writeFile(
        wb,
        `keyvalue-${new Date().toISOString().slice(0,10)}.xlsx`
    );
});
document
...
.addEventListener('click', () => {
    ...
    doc.save(
        `keyvalue-${new Date().toISOString().slice(0,10)}.pdf`
    );
});
});
</script>

        ...
        <div class="card">
            ...
            <div
                ...
                <div class="d-flex align-items-center gap-3 flex-nowrap">
                    ...
                    <a href="{{ backpack_url('utils/keyword-master/create') }}" class="btn btn-blue btn-sm fw-bold shadow-sm">
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    const allBtn =
        document.getElementById('btnAllHeaders');

    document
.getElementById('btnDefaultHeaders')
.addEventListener('click', () => {
    ...
    const bubbleBody =
        document.getElementById('columnBubbleBody');

const closeBubble =
    document.getElementById('closeColumnBubble');

    const defaultBtn =
    document.getElementById('btnDefaultHeaders');
    ...
    ALL_COLUMNS.forEach(col => {
        ...
        const checked =
            gridApi.getColumn(col.field)?.isVisible()
            ? 'checked'
            : '';
    ...
    document
        .querySelectorAll('.column-toggle')
        .forEach(cb => {
...
.addEventListener('click', () => {
    ...
    XLSX.writeFile(
        wb,
        `keyword-master-${new Date().toISOString().slice(0,10)}.xlsx`
    );
});
document
...
.addEventListener('click', () => {
    ...
    doc.save(
        `keyword-master-${new Date().toISOString().slice(0,10)}.pdf`
    );
});
});
</script>

                        ...
                        <div class="row">
                            ...
                            <div class="col-md-3 mb-3">
                                ...
                                <select name="keyword_code" class="form-control form-select" required>
                                    ...
                                    <option value="{{ $keyword->code }}" {{ old('keyword_code')==$keyword->code ?
                                        'selected' : '' }}>
                            ...
                            <div class="col-md-3 mb-3">
                                ...
                                <input type="number" name="level" class="form-control" value="{{ old('level', 0) }}">
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <textarea name="extra_data" rows="4"
                                    class="form-control">{{ old('extra_data') }}</textarea>

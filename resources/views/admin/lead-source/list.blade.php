        ...
        <div class="card">
            <div
                ...
                <div class="d-flex align-items-center gap-3 flex-nowrap">
                    <a href="{{ backpack_url('sales/lead-source/create') }}" class="btn btn-blue btn-sm fw-bold shadow-sm">
                        <i class="la la-plus me-1"></i> Add New Source
                    </a>
                </div>
            </div>
...
<script>
    ...
    const columnDefs = [
       ...
       // ...ALL_COLUMNS.filter(col => ['sort_order'].includes(col.field)),
    ...
    document.addEventListener('DOMContentLoaded', () => {
        ...
        document.getElementById('exportCsv').addEventListener('click', () => {
            ...
            XLSX.utils.book_append_sheet(wb, ws, "Lead Source");
            XLSX.writeFile(wb, `lead-source-${new Date().toISOString().slice(0,10)}.xlsx`);
        });
        ...
        document.getElementById('exportPdf').addEventListener('click', () => {
            ...
            doc.save(`lead-source-${new Date().toISOString().slice(0,10)}.pdf`);
        });
    });
</script>
@endpush
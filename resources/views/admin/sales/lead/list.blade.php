...
@push('after_scripts')
    ...
    <script>
        ...
        const ALL_COLUMNS =
            @json($gridConfig['columns'] ?? []);

        function getCols(fields) {

            return ALL_COLUMNS.filter(

                col => fields.includes(col.field)
            ...
            <div class="card">
                ...
                <div
                    ...
                    <div class="d-flex align-items-center gap-3 flex-nowrap">
                        ...
                        <a href="{{ backpack_url('sales/lead/create') }}" class="btn btn-blue btn-sm fw-bold shadow-sm">
                    ...
                    <div
                        ...
                        <div class="d-flex gap-2 flex-wrap justify-content-center">
                            ...
                            <div class="position-relative d-inline-block">
                                ...
                                <button id="btnCustomiseHeaders" class="btn btn-red btn-sm">
                            ...
                            <button id="btnAllHeaders" class="btn btn-blue btn-sm">
                        ...
                        <div class="d-flex gap-2 flex-wrap">
                            ...
                            <button id="exportCsv" class="btn btn-sm text-nowrap d-flex align-items-center gap-2">
                                ...
                                <img src="{{ asset('images/export-excel.png') }}" style="height:30px;width:auto;"
                                    alt="Excel">
                            ...
                            <button id="exportPdf" class="btn btn-sm text-nowrap d-flex align-items-center gap-2">
                                ...
                                <img src="{{ asset('images/export-pdf.png') }}" style="height:30px;width:auto;" alt="PDF">

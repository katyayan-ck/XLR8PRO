...
@section('title', 'RTO Charges List')
            ...
            <div class="card">
                <div class="card-header bg-gradient-primary d-flex justify-content-between align-items-center flex-nowrap flex-md-nowrap flex-wrap gap-3">
                    <h2 class="card-title mb-0 fw-bold text-black text-nowrap">
                        {{ $title ?? 'RTO Charges List' }}
                    </h2>
                    <div class="d-flex align-items-center gap-3 flex-nowrap">
                        <a href="{{ backpack_url('rto-charges/create') }}" class="btn btn-blue btn-sm fw-bold shadow-sm">
                            <i class="la la-plus me-1"></i>Add RTO Charges
                        </a>
                    </div>
                </div>
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    document.getElementById('exportCsv').addEventListener('click', () => {
        ...
        XLSX.utils.book_append_sheet(wb, ws, 'RTO Charges');
        XLSX.writeFile(wb, `rto-charges-${new Date().toISOString().slice(0, 10)}.xlsx`);
    });
    ...
    document.getElementById('exportPdf').addEventListener('click', () => {
        ...
        doc.save(`rto-charges-${new Date().toISOString().slice(0, 10)}.pdf`);
    });
});
</script>
@endpush

...
@section('title', 'Edit Keyword - ' . $keywordMaster->keyword)
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-3 mb-3">
                                ...
                                <input type="text" name="code" class="form-control"
                                    value="{{ old('code', $keywordMaster->code) }}" required minlength="3"
                                    maxlength="50">
                            ...
                            <div class="col-md-3 mb-3">
                                ...
                                <input type="text" name="keyword" class="form-control"
                                    value="{{ old('keyword', $keywordMaster->keyword) }}" required maxlength="255">
                            </div>
                            ...
                            <div class="col-md-3 mb-3">
                                ...
                                <input type="text" name="description" class="form-control"
                                    value="{{ old('description', $keywordMaster->description) }}">
                            </div>
                            {{-- Is Active --}}
                            <div class="col-md-1 mb-3">
                                ...
                                <div class="form-check form-switch">
                                    ...
                                    <input type="checkbox" name="is_active" value="1" class="form-check-input" {{
                                        old('is_active', $keywordMaster->is_active) ? 'checked' : '' }}>
                            ...
                            <div class="col-md-2 mb-3">
                                ...
                                <div class="form-check form-switch">
                                    ...
                                    <input type="checkbox" name="is_recursive" value="1" class="form-check-input" {{
                                        old('is_recursive', $keywordMaster->is_recursive) ? 'checked' : '' }}>
                            ...
                            <div class="col-md-4 mb-3">
                                ...
                                <textarea name="details" rows="4"
                                    class="form-control">{{ old('details', $keywordMaster->details) }}</textarea>

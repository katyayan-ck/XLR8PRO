        ...
        <div class="card">
            <div
                ...
                <div class="d-flex align-items-center gap-3 flex-nowrap">
                    <a href="{{ backpack_url('org/designation/create') }}" class="btn btn-blue btn-sm fw-bold shadow-sm">
...
<script>
    ...
    const columnDefs = [
        ...ALL_COLUMNS.filter(col => ['serial_no', 'code', 'name', 'guard_name'].includes(col.field)),

        ...ALL_COLUMNS.filter(col => ['description', 'hierarchy_level', 'rank', 'category', 'is_top_mgmt', 'parent_desig_code'].includes(col.field)),
    ...
    const gridOptions = {
        ...
        onGridReady: params => {
            ...
            const defaultFields = ['serial_no', 'code', 'name', 'guard_name', 'description', 'hierarchy_level', 'rank', 'category', 'is_top_mgmt', 'parent_desig_code', 'is_active', 'action'];

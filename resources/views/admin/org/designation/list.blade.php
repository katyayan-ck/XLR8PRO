...
@section('title', $title ?? 'All Designations')
...
<script>
    ...
    const columnDefs = [
        ...
        ...getCols(['rank', 'parent_desig_code', 'is_top_mgmt', 'description', 'is_active']),
    ...
    const defaultFields = [
        'serial_no', 'image', 'code', 'name', 'rank', 'parent_desig_code', 'is_top_mgmt', 'description', 'is_active', 'action'
    ];
    ...
    function openColumnBubble() {
        ...
        const allFlatColumns = [
            ...getCols(['serial_no', 'image', 'code', 'name', 'rank', 'parent_desig_code', 'is_top_mgmt', 'description', 'is_active', 'action'])
        ];

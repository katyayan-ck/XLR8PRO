...
<script>
    ...
    const columnDefs = [
        ...getCols(['serial_no', 'person_code', 'entity_type', 'salutation', 'full_name', 'display_name']).map(col => {
        ...
        ...getCols(['gender', 'dob', 'marital_status', 'spouse_name', 'occupation']),

        ...getCols(['aadhaar_no', 'pan_no', 'tan_no', 'gst_no', 'extra_data']),
    ...
    const gridOptions = {
        ...
        onGridReady: params => {
            ...
            const defaultFields = ['serial_no', 'person_code', 'entity_type', 'salutation', 'full_name', 'display_name', 'gender', 'dob', 'marital_status', 'spouse_name', 'occupation', 'aadhaar_no', 'pan_no', 'tan_no', 'gst_no', 'extra_data', 'action'];
    ...
    function openColumnBubble() {
        ...
        const allFlatColumns = [
            ...getCols(['serial_no', 'person_code', 'entity_type', 'salutation', 'full_name', 'display_name']),
            ...getCols(['gender', 'dob', 'marital_status', 'spouse_name', 'occupation']),
            ...getCols(['aadhaar_no', 'pan_no', 'tan_no', 'gst_no', 'extra_data']),
            ...getCols(['action'])
        ];
        ...
        allFlatColumns.forEach(col => {
            ...
            if (['serial_no', 'person_code', 'full_name', 'display_name'].includes(col.field)) {
        ...
        <div class="card">
            ...
            <div
                ...
                <div class="d-flex align-items-center gap-3 flex-nowrap">
                    <a href="{{ backpack_url('org/person/create') }}" class="btn btn-blue btn-sm fw-bold shadow-sm">

        ...
        <div class="card">
            <div
                ...
                <div class="d-flex align-items-center gap-3 flex-nowrap">
                    <a href="{{ backpack_url('org/division/create') }}" class="btn btn-blue btn-sm fw-bold shadow-sm">
...
<script>
    ...
    const columnDefs = [
        ...
        ...ALL_COLUMNS.filter(col => ['dept_code', 'code', 'name'].includes(col.field)),

        ...ALL_COLUMNS.filter(col => ['description', 'head_code'].includes(col.field)),
    ...
    htmlRenderer: function(params) {
        ...
        onGridReady: params => {
            ...
            const defaultFields = ['serial_no', 'image', 'dept_code', 'code', 'name', 'description', 'head_code', 'action'];
    ...
    gridApi.setColumnsVisible([col], true);
});
    ...
    function openColumnBubble() {
        ...
        const allFlatColumns = [
            ...ALL_COLUMNS.filter(col => ['serial_no', 'image', 'dept_code', 'code', 'name'].includes(col.field)),
            ...ALL_COLUMNS.filter(col => ['description', 'head_code'].includes(col.field)),
            ...ALL_COLUMNS.filter(col => ['is_active'].includes(col.field)),
        ...
        allFlatColumns.forEach(col => {
            ...
            if (['serial_no', 'dept_code', 'code', 'name', 'description', 'head_code', 'action'].includes(col.field)) {

...
@section('title', $title ?? 'All Divisions')
...
<script>
    ...
    const columnDefs = [
        ...
        ...getCols(['serial_no', 'dept_code', 'code', 'name']).map(col => {
    ...
    const defaultFields = [
        'serial_no', 'image', 'dept_code', 'code', 'name', 'description', 'is_active', 'action'
    ];
    ...
    function openColumnBubble() {
        ...
        const allFlatColumns = [
            ...getCols(['serial_no', 'image', 'dept_code', 'code', 'name', 'description', 'is_active', 'action'])
        ];
        ...
        allFlatColumns.forEach(col => {
            ...
            if (['serial_no', 'code', 'name', 'dept_code', 'action'].includes(col.field)) {

...
@section('title', $title ?? 'All Verticals')
...
<script>
    ...
    const columnDefs = [
        ...
        ...getCols(['serial_no', 'code', 'vert_code', 'name']).map(col => {
    ...
    const defaultFields = [
        'serial_no', 'image', 'code', 'vert_code', 'name', 'description', 'is_active', 'action'
    ];
    ...
    function openColumnBubble() {
        ...
        const allFlatColumns = [
            ...getCols(['serial_no', 'image', 'code', 'vert_code', 'name', 'description', 'is_active', 'action'])
        ];

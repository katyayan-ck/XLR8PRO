...
@section('title', $title ?? 'All Locations')
...
<script>
    ...
    const columnDefs = [
        ...
        ...getCols(['serial_no', 'branch', 'code', 'name']).map(col => {
        ...
        ...getCols(['description', 'address', 'phone', 'email', 'city', 'state', 'pincode', 'latitude', 'longitude']),
        ...getCols(['is_active', 'is_sales_location', 'is_workshop', 'is_parts_location', 'is_stock_location', 'is_office_only', 'is_mwh', 'is_lmmws']),
    ...
    const defaultFields = [
        'serial_no', 'image', 'branch', 'code', 'name', 'description', 
        'phone', 'email', 'city', 'state', 'pincode', 
        'is_active', 'is_sales_location', 'is_workshop', 'is_parts_location', 
        'is_stock_location', 'is_office_only', 'is_mwh', 'is_lmmws', 'action'
    ];
    ...
    function openColumnBubble() {
        ...
        const allFlatColumns = [
            ...getCols(['serial_no', 'image', 'branch', 'code', 'name', 'description']),
            ...getCols(['phone', 'email', 'address', 'city', 'state', 'pincode', 'latitude', 'longitude']),
            ...getCols(['is_active', 'is_sales_location', 'is_workshop', 'is_parts_location', 'is_stock_location', 'is_office_only', 'is_mwh', 'is_lmmws', 'action'])
        ];
        ...
        allFlatColumns.forEach(col => {
            ...
            if (['serial_no', 'code', 'name', 'branch', 'action'].includes(col.field)) {

...
namespace App\Http\Controllers\Admin\Accounts\Receipt;
 ...
 * a setupXxxOperation() lifecycle hook.
 */
class ReceiptCrudController extends Controller
{
    ...
    public function index()
    {
        if (! backpack_user()->can('ACC_RCPT_VIEW')) {
            abort(403, 'Unauthorized. You do not have permission to view receipts.');
        }
    ...
    {
        if (! backpack_user()->can('ACC_RCPT_CREATE')) {
            abort(403, 'Unauthorized. You do not have permission to create receipts.');
        }
    ...
    {
        if (! backpack_user()->can('ACC_RCPT_EDIT')) {
            abort(403, 'Unauthorized. You do not have permission to edit receipts.');
        }
    ...
    {
        if (! backpack_user()->can('ACC_RCPT_CREATE') && ! backpack_user()->can('ACC_RCPT_EDIT')) {
